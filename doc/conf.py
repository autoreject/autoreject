...
project = u'autoreject'
copyright = u'2016, Mainak Jas'
author = u'Mainak Jas'
...
htmlhelp_basename = 'autorejectdoc'
...
latex_documents = [
    (master_doc, 'autoreject.tex', u'autoreject Documentation',
     u'Mainak Jas', 'manual'),
]
...
man_pages = [
    (master_doc, 'autoreject', u'autoreject Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'autoreject', u'autoreject Documentation',
     author, 'autoreject', 'One line description of project.',
     'Miscellaneous'),
]
