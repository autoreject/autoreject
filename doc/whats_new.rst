...
- Add :meth:`autoreject.RejectLog.drop_epochs_with_adjacent_channel_interpolation`, :meth:`autoreject.RejectLog.interpolate_bads` and :meth:`autoreject.RejectLog.drop_epochs_with_bads` for post-doc corrections to ensure the cleanest possible data as shown in :ref:`plot_autoreject_workflow`, by `Alex Rockhill`_ :github:`XXX`

- Add :meth:`autoreject.RejectLog.save` and :func:`autoreject.read_reject_log` to save and load reject logs, by `Alex Rockhill`_ :github:`XXX`
